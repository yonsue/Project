...
<body>
	<div>
		<div class="container">
			...
			<div class="mid-block" style="margin:200px auto">
				<input id="applober" type="image" src="resources/goats_icon/app.png" style="width:80px; height:40px;"
					style="margin-top: 190px;"><br> <br> <br> <br><br> <br> <br> <br>
				<input id="reference_btn" type="image" src="resources/goats_icon/cham.png" style="width:80px; height:40px;"
